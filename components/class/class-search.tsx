...
export const ServerSearch =({
    ...
    const onClick = ({id,type}:{id:string, type:"channel"|"member"})=>
    {
        setOpen(false)
        if(type==="member"){
            return router.push(`/classes/${params?.serverId}/conversations/${id}`)
        }
        if(type=== "channel"){
            return router.push(`/classes/${params?.serverId}/channels/${id}`)
        }
    }
    ...
    return(
        <>
            ...
            <CommandDialog open={open} onOpenChange={setOpen}>
                ...
                <CommandInput placeholder="Tìm kiếm phòng và thành viên" />
                <CommandList>
                    <CommandEmpty>
                        Không tìm thấy
                    </CommandEmpty>

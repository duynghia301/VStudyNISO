      ...
      <div className="p-6">
        <div className=" flex items-center justify-between">
          <div className=" flex flex-col gap-y-2">
            <h1 className="text-2x1 font-medium">Chuẩn bị khóa học</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ChaprersForm initialData={course} courseId={course.id} />
            </div>
            <div>
              <div className="flex items-center gap-x-2">
                <IconBadge icon={CircleDollarSign} />
                <h2 className="text-xl">Giá khóa học</h2>
              </div>
            ...
            <div>
              <div className="flex items-center gap-x-2">
                <IconBadge icon={File} />
                <h2 className="text-xl">Tài liệu & Video</h2>
              </div>
              <AttachmnetForm initialData={course} courseId={course.id} />
            </div>
          </div>
        </div>
      </div>
